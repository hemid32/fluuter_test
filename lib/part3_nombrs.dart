...
class part3 extends StatefulWidget {
  final info3 ;
  final file ;
  const part3({Key key ,this.file, this.info3}) : super(key: key );
  @override
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: _mybody3(myController,context , widget.info3 , widget.file),
      ),
    );

  }
}
Widget _mybody3(myController,context , info3,file){
  // qstion from data

  var  methode = info3['method'];
  var  qs = info3['qst'] ;
  var crr = info3['crr'] ;
  return  ListView(
      children: <Widget>[
